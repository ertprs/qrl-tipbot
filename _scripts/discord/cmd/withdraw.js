module.exports = {
  ...
  execute(message, args) {
    ...
    async function main() {
      ...
      const wdDbInfo = { user_id: check[0].userArray[0][0].user_id, tx_hash: transferFundsOut.tx.transaction_hash, to_address: check[0].addressArray, amt: check[0].amtArray };
