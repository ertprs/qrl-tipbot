...
- The Tip Bot will never share any Private Keys with the user. 
...
:small_orange_diamond: *All tips are final once sent. Tips will never be refunded or returned to a user, for any reason.*
:small_orange_diamond: *This service is for tipping or giving small amounts of QRL to other users.*
:small_orange_diamond: *You agree to not store or trade currency or for any other reason than tipping users.*
:small_orange_diamond: *You will not store large amounts of QRL in this address at any time.*
:small_orange_diamond: *You take full responsibility for transferring funds out of the Tipbot, using the \`+transfer\` function into wallets you control.
:small_orange_diamond: *You will not use this bot if it will in any way break any law, in any jurisdiction. \`+opt-out\` to disable your account.*
:small_orange_diamond: *You will not use this bot in any way that is not intended or identified in these rules.*
:small_orange_diamond: *Any tips sent to a user that has not signed up will be saved by the bot for that user. Failure of the user to collect tips in this time may result in a loss of funds for that user and they will not be returned to the sender. These lost tips will fund the faucet and cover any operational costs that may incur.*
:small_orange_diamond: *Any abuse of the service will result in a ban, and if warranted legal action may be taken accordingly. Funds will not be returned to banned users.*

**If you *AGREE* to these terms, type:** \`+agree\`
**If you *DO NOT AGREE* to these terms, type:** \`+opt-out\`
                    `);
                    message.channel.stopTyping(true);
