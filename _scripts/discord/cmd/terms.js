module.exports = {
  ...
  execute(message) {
    ...
    message.author.send(':exclamation: __**TipBot Terms and Conditions**__ :exclamation:\n:diamond_shape_with_a_dot_inside: Use of this TipBot and any function it may provide to you, as the user, is at your risk.\n:diamond_shape_with_a_dot_inside: By using this service you agree to not hold liable, for any reasons, the owner, operators, or any affiliates of the QRL TipBot or anyone associated with this service.\n:diamond_shape_with_a_dot_inside: By using this service, you agree to not abuse or misuse the service and will follow the rules listed below. \n:diamond_shape_with_a_dot_inside: Abuse of this service may result in a ban from the service and if warranted legal action may be taken. \n:diamond_shape_with_a_dot_inside: By using this service you agree to share information about your social media account used for signup to the TipBot service including but not limited to, service user name(s), service user ID(s), all interactions and messages with the bot, and any other public information available through the social media API services.\n:diamond_shape_with_a_dot_inside: At no point will this information be sold or used for any purpose other than this TipBot service, and is only stored for the purpose of managing your accounts.\n:diamond_shape_with_a_dot_inside: All funds must be withdrawn to a user controlled account. \n:diamond_shape_with_a_dot_inside: Any funds left on the bot may be lost at any time, and the user agrees that this is an acceptable loss. \n:diamond_shape_with_a_dot_inside: Funds shall be withdrawn from the bot regularly into user controlled wallets.\n:diamond_shape_with_a_dot_inside: Users will not store large amounts of funds in any tipbot wallet\n\n__**You assume all risk by using this service**__'
                    )
      .catch(error => {
