...
Discord TipBot Started
  {blue !} Connected to {bgBlue.black ${client.guilds.cache.size}} guilds.
 {blue !} With {red ${client.users.cache.size}} users 
 {blue !} In {green ${client.channels.cache.size}} channels 
==========================
    `);
