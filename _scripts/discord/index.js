...
Discord TipBot Started
 {bgBlue {green {bold !}} Connected to ${client.guilds.cache.size} guilds }
 {blue.bold !} With {bgBlue ${client.users.cache.size} users } 
 {blue.bold !} In {bgBlue ${client.channels.cache.size} channels }
==========================
    `);
