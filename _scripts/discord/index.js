...
client.on('ready', () => {
  ...
  console.log('client.users ' + JSON.stringify(client.client.channels));
  console.log(`Discord Bot has started, with ${client.users.cache.size} users, in ${client.channels.size} channels of ${client.guilds.size} guilds.`);
