...
Discord TipBot Started
  {blue.bold !} Connected to {bgBlue.black ${client.guilds.cache.size}} guilds.
 {blue.bold !} With {red ${client.users.cache.size}} users 
 {blue.bold !} In {green ${client.channels.cache.size}} channels 
==========================
    `);
