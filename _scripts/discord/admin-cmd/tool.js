        ...
        if (args[0] === 'count' || args[0] === 'cnt') {
          ...
          getNodeInfo().then(function(info) {
            ...
            const embed = new Discord.MessageEmbed()
              ...
              .addField('Version', parsedInfo.version, true)
              .addField('Network ID', parsedInfo.network_id, true)
              .addField('Number of Connections', parsedInfo.num_connections, true)
              .addField('Number of Known Peers', parsedInfo.num_known_peers, true)
              .addField('Node Uptime', parsedInfo.uptime, true)
              .addField('Block Height', parsedInfo.block_height, true)
              .addField('Block Last Hash', parsedInfo.block_last_hash, true)
